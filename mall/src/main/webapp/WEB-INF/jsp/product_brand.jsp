...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a></span> <span class="r">共有数据：<strong>${pnumber}</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<c:forEach items="${plist}" var="p">
				<tr class="text-c">
					...
					<td>${p.pid}</td>
					<td><input type="text" class="input-text text-c" value="${p.type}"></td>
					<td><img src="/images/${p.image}" style="width: 140px;height: 80px;"></td>
